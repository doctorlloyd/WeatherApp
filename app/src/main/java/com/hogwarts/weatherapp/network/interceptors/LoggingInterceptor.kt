package com.hogwarts.weatherapp.network.interceptors

import android.content.ContentValues.TAG
import android.util.Log
import com.hogwarts.weatherapp.BuildConfig
...
class LoggingInterceptor : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (BuildConfig.DEBUG) {
            ...
            Log.d(TAG, "intercept: [" + request.method().toUpperCase(Locale.ROOT) + "] " + request.url().toString())
            Log.d(
